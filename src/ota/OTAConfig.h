...
#define OFFLOADED_DOWNLOAD
  ...
  #define ARDUINO_ZEPHYR_OTA_MAGIC 0x2341025b
#endif
#if defined(ARDUINO_NICLA_VISION)
  #define ARDUINO_ZEPHYR_OTA_MAGIC 0x2341025f
#endif
#if defined(ARDUINO_OPTA)
  #define ARDUINO_ZEPHYR_OTA_MAGIC 0x23410064
#endif
#if defined(ARDUINO_GIGA)
  #define ARDUINO_ZEPHYR_OTA_MAGIC 0x23410266
#endif
#if defined(ARDUINO_PORTENTA_C33)
  #define ARDUINO_ZEPHYR_OTA_MAGIC 0x23410068
#endif
