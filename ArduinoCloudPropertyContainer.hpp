...
class ArduinoCloudPropertyContainer {
  public:
    ...
    inline ArduinoCloudProperty<bool>   * getPropertyBool(String const & name) {
      return getProperty(_bool_property_list,   name);
    }
    inline ArduinoCloudProperty<int>    * getPropertyInt(String const & name) {
      return getProperty(_int_property_list,    name);
    }
    inline ArduinoCloudProperty<float>  * getPropertyFloat(String const & name) {
      return getProperty(_float_property_list,  name);
    }
    inline ArduinoCloudProperty<String> * getPropertyString(String const & name) {
      return getProperty(_string_property_list, name);
    }

    inline void addProperty(ArduinoCloudProperty<bool>   * property_obj) {
      _bool_property_list.add(property_obj);
    }
    inline void addProperty(ArduinoCloudProperty<int>    * property_obj) {
      _int_property_list.add(property_obj);
    }
    inline void addProperty(ArduinoCloudProperty<float>  * property_obj) {
      _float_property_list.add(property_obj);
    }
    inline void addProperty(ArduinoCloudProperty<String> * property_obj) {
      _string_property_list.add(property_obj);
    }
