...
SCENARIO("Arduino Cloud Properties are decoded", "[ArduinoCloudThing::decode]") {
  ...
  WHEN("A String property is changed via CBOR message") {
    GIVEN("CloudProtocol::V2") {
      ...
      str_test = "test";
      property_container.addPropertyReal(str_test, "test", Permission::ReadWrite);
  ...
  WHEN("A DimmedLight property is changed via CBOR message") {
    GIVEN("CloudProtocol::V2") {
      ...
      property_container.addPropertyReal(light_test, "test", Permission::ReadWrite);
  ...
  WHEN("A ContactSensor property is changed via CBOR message") {
    GIVEN("CloudProtocol::V2") {
      ...
      property_container.addPropertyReal(contact_test, "test", Permission::ReadWrite);
  ...
  WHEN("A MotionSensor property is changed via CBOR message") {
    GIVEN("CloudProtocol::V2") {
      ...
      property_container.addPropertyReal(motion_test, "test", Permission::ReadWrite);
  ...
  WHEN("A SmartPlug property is changed via CBOR message") {
    GIVEN("CloudProtocol::V2") {
      ...
      property_container.addPropertyReal(plug_test, "test", Permission::ReadWrite);
  ...
  WHEN("A Switch property is changed via CBOR message") {
    GIVEN("CloudProtocol::V2") {
      ...
      property_container.addPropertyReal(switch_test, "test", Permission::ReadWrite);
  ...
  WHEN("Multiple properties is changed via CBOR message") {
    GIVEN("CloudProtocol::V2") {
      ...
      ArduinoCloudThing thing;
        ...
        property_container.addPropertyReal(bool_test,  "bool_test",  Permission::ReadWrite).onSync(CLOUD_WINS);
        property_container.addPropertyReal(int_test,   "int_test",   Permission::ReadWrite).onSync(CLOUD_WINS);
        property_container.addPropertyReal(float_test, "float_test", Permission::ReadWrite).onSync(CLOUD_WINS);
        property_container.addPropertyReal(str_test,   "str_test",   Permission::ReadWrite).onSync(CLOUD_WINS);
      ...
      ArduinoCloudThing thing;
        ...
        property_container.addPropertyReal(*f, "float_test", Permission::ReadWrite).onSync(CLOUD_WINS);
        property_container.addPropertyReal(*s, "str_test",   Permission::ReadWrite).onSync(CLOUD_WINS);
      ...
      ArduinoCloudThing thing;
        ...
        property_container.addPropertyReal(str_1, "str_1", Permission::ReadWrite);
        property_container.addPropertyReal(str_2, "str_2", Permission::ReadWrite);
        property_container.addPropertyReal(str_3, "str_3", Permission::ReadWrite);
        property_container.addPropertyReal(str_4, "str_4", Permission::ReadWrite);
  ...
  WHEN("A payload containing a CBOR base name is parsed") {
    GIVEN("CloudProtocol::V2") {
      ...
      property_container.addPropertyReal(str, "test", Permission::ReadWrite);
