...
bool ArduinoCloudPropertyContainer::isPropertyInContainer(Type const type, String const & name) {
  if (type == Type::Bool) {
    return isPropertyInList(_bool_property_list,   name);
  } else if (type == Type::Int) {
    return isPropertyInList(_int_property_list,    name);
  } else if (type == Type::Float) {
    return isPropertyInList(_float_property_list,  name);
  } else if (type == Type::String) {
    return isPropertyInList(_string_property_list, name);
  } else {
    return false;
  }
}
